...
public class EstoqueDbContext : DbContext
{
    ...
    public DbSet<ProcessedEvent> ProcessedEvents { get; set; } // NOVA TABELA

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        base.OnModelCreating(modelBuilder);

        // Configuração da entidade Produto (mantém o mesmo)
        ...
        // Configuração da entidade ProcessedEvent
        modelBuilder.Entity<ProcessedEvent>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.EventType, e.EventId })
                .IsUnique()
